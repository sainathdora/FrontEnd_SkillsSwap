    ...
    return (
        <nav className="bg-white shadow-md">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16">
                    <div className="flex-shrink-0 flex items-center">
                        <Link to="/" className="text-xl font-bold text-gray-800">SkillSwap</Link>
                    </div>
            ...
            <div id="mobile-menu" className="hidden md:hidden bg-white border-t border-gray-200">
                ...
                <a href="#" className="block px-4 py-2 bg-blue-600 text-white text-center hover:bg-blue-700">Register</a>
            </div>
        </nav>
    );
}
